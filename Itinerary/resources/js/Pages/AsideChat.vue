<template>
    ...
    <div class="bg-white py-5 w-64 flex flex-col">

        <button @click="createNewRoomModal = true" class="mr-2 flex items-center align-middle py-2 bg-white shadow-md  rounded-3xl text-gray-800 text-sm font-semibold ml-3 border border-gray-200 hover:shadow-xl transition-all w-52  focus:outline-none">
