        ...
        <div class="py-12">
            ...
            <div class="border ">
                <div v-for="roomUser in roomUsers" :key="roomUser.id" class="border-b-2 flex justify-between space-y-3 items-center">
                    ...
                    <svg @click="userBan(roomUser)" v-show="roomUser.name == room.owner" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-300 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
